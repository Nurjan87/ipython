...
def createInstance(ami, mincount, maxcount, instancetype='t2.nano', keyname='mac'):
...
images = {'amznlinux':'ami-056ee704806822732', 'centos':'ami-074e2d6769f445be5'}
...
def main():
    ...
    if(args.name):
        if (args.name in images.keys()):
            key = args.key if args.key else 'mac'
